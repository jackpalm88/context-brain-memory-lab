...
real_version: 1.0.0
release_state: v1.0.0 TAGGED (tag object 1c4293a → commit 4f6a100, 2026-07-05); post-1.0 consumer-driven evolution closed its first full cycle — CF-001..CF-005 all Stage 1 resolved, Stage 2 items evidence-gated; GPT Actions consumer surface live on dev; STATE refreshed at current HEAD 3a78fc0 after green hermetic gate on 2026-07-24
...
last_green_gate: 1744 passed / 92 skipped / 0 failed (hermetic env -i via scripts/hermetic_test.sh, 2026-07-24, HEAD 3a78fc0)
