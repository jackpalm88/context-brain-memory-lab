...
real_version: 1.0.0
release_state: v1.0.0 TAGGED (tag object 1c4293a → commit 4f6a100, 2026-07-05); post-1.0 consumer-driven evolution closed its first full cycle — CF-001..CF-005 all Stage 1 resolved, Stage 2 items evidence-gated; 2026-08-10 pre-marketing release-truth audit closed (mcp<2 pin, seed/quickstart fixes, auth/SECURITY.md truth, docs/MCP.md, README rewrite); GPT Actions consumer surface: minimal schema removed, real production Action A+B pair (35 ops, OpenCB decision df97aa73) published as canonical with restored epistemic discipline in the system prompt; STATE refreshed at current HEAD c19a2a0 after green hermetic gate on 2026-08-10
...
last_green_gate: 1753 passed / 92 skipped / 0 failed (hermetic env -i via scripts/hermetic_test.sh, 2026-08-10, HEAD c19a2a0)
