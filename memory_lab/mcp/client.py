...
class MemoryLabApiClient:
    ...
    def canonical_body_get(
        self, content_id: str, workspace_id: Optional[str] = None, expected_version: Optional[str] = None
    ) -> Dict[str, Any]:
        params = {"expected_version": expected_version} if expected_version is not None else None
        return self._request(
            "GET", f"/v1/content/{content_id}/canonical-body", params=params, workspace_id=workspace_id
        )
