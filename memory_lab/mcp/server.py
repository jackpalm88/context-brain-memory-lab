...
server.tool()(APPROVED_TOOLS["get_canonical_body_verified"])
server.tool()(APPROVED_TOOLS["list_current_state_anchors"])
server.tool()(APPROVED_TOOLS["trusted_promote_current_state"])
...
server.tool()(APPROVED_TOOLS["list_decisions_for_content"])
