...
def capability_metadata_schema() -> dict[str, Any]:
    return {"type":"object","required":["capability","mode","input_scope","live_backend_used","requires_provider","requires_db","requires_private_context_brain","uses_embeddings","uses_vector_db","mutates_state","limitations","non_claims","degraded_reason"],"properties":{"capability":{"type":"string"},"mode":{"const":"deterministic_public_safe_supplied_input_only"},"input_scope":{"const":"caller_supplied_payload_only"},"live_backend_used":{"const":False},"requires_provider":{"const":False},"requires_db":{"const":False},"requires_private_context_brain":{"const":False},"uses_embeddings":{"const":False},"uses_vector_db":{"const":False},"mutates_state":{"const":False},"limitations":{"type":"array","items":{"type":"string"}},"non_claims":{"type":"array","items":{"type":"string"}},"degraded_reason":{"type":["string","null"]}}}
